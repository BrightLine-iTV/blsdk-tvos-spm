...
-(void)BLAdUnavailableWithMessage:(NSString*)message withErrorCode:(NSString*)errorCode withUrl:(NSString*)url;
//- (void)BLAdUnavailableWithMessage:(NSString*)errorCode andMessage:(NSString*)message andUrl:(NSString*)url;
